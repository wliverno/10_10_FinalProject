%  Project_10_10_Spring_2013
%  By: Alissa Borshchenko and William Livernois
%  Using outline code and comments provided by Professor Stephanopoulos
...
% The Set_Parameters function visits: MaterialsProperties,
% ReactionsProperties, ProcessUnitsParameters, EconomicData, ReactorFeed
...
%  The simulator visits these functions: Reactor, Extractor, Distillation,
%  Crystallizer, Dryer, Waste_Treatment (all contain mass/energy balance equations relating to
%  the specific control volumes of the system).
